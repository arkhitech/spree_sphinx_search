ThinkingSphinx::Index.define('spree/howmuch_shop', with: :active_record, delta: ThinkingSphinx::Deltas::SidekiqDelta) do
    ...
    indexes :description
    indexes address.phone, as: :phone
    indexes address.alternative_phone, as: :alternative_phone
    ...
    indexes address.zipcode, as: :zipcode
    
    indexes address.state_name, as: :state_name
